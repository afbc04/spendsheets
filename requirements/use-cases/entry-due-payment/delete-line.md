...
- **Title:** Delete Line of Entry Due Payment
- **Description:** Administrators can delete line of due payment entries
- **Pre-condition:** User must be Administrator, line and entry must exists & Entry can not be DONE
- **Pos-condition:** Due Payment Entry has less movements

# Flow

### Normal Flow

1. User initiates the delete line of due payment entry process.
