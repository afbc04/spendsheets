...
- **Title:** Add Line of Entry Due payment
- **Description:** Administrators can add line in entry due payment
...
1. User initiates the add line in due payment entry process.
2. User provides:
