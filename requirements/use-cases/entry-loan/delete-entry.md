...
- **Title:** Delete Entry Loan
- **Description:** Administrators can delete loan entries
- **Pre-condition:** User must be Administrator & entry must exists
- **Pos-condition:** Loan Entry is deleted

# Flow

### Normal Flow

1. User initiates the delete loan entry process.
...
### Alternative Flow (3) [Loan Entry has movements related to entry]
