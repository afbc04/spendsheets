...
- **Title:** Delete Line of Entry Loan
- **Description:** Administrators can delete line of loan entries
- **Pre-condition:** User must be Administrator, line and entry must exists & Entry can not be DONE
- **Pos-condition:** Loan Entry has less movements

# Flow

### Normal Flow

1. User initiates the delete line of loan entry process.
